...
//
///////////////////////////////////////////
Shader "Custom/BattleBackgroundAddGlow" {
Properties {
...
SubShader {
 Tags { "CanUseSpriteAtlas" = "true" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderEffect" = "Glow11Transparent" "RenderType" = "Glow11Transparent" }
 Pass {
  Tags { "CanUseSpriteAtlas" = "true" "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderEffect" = "Glow11Transparent" "RenderType" = "Glow11Transparent" }
...
void main()
{
    ...
    u_xlat9 = (-_Ydown) + _Yup;
    u_xlat0.z = abs(u_xlat0.x) * u_xlat9 + _Ydown;
    ...
    u_xlat5 = _Time.x * 50.0 + -0.200000003;
    u_xlatb2.y = vs_TEXCOORD0.x>=u_xlat5;
    u_xlat2.xy = mix(vec2(0.0, 0.0), vec2(1.0, 1.0), vec2(u_xlatb2.xy));
    u_xlat2.x = u_xlat2.y * u_xlat2.x;
    u_xlat0 = u_xlat1 * u_xlat2.xxxx + u_xlat0;
    u_xlat10_1 = texture2D(_AlphaTex, vs_TEXCOORD1.xy).x;
    u_xlat9 = u_xlat0.w * u_xlat10_1;
    u_xlat9 = u_xlat9 * _Color.w;
    u_xlat9 = u_xlat9 * vs_COLOR0.w;
    u_xlat1.xyz = vec3(u_xlat9) * u_xlat0.xyz;
    u_xlat0.xyz = (-u_xlat0.xyz) * vec3(u_xlat9) + _FarFogColor.xyz;
    u_xlat2.xyz = vs_TEXCOORD4.yyy * hlslcc_mtx4x4unity_ObjectToWorld[1].xyz;
    u_xlat2.xyz = hlslcc_mtx4x4unity_ObjectToWorld[0].xyz * vs_TEXCOORD4.xxx + u_xlat2.xyz;
    u_xlat2.xyz = hlslcc_mtx4x4unity_ObjectToWorld[2].xyz * vs_TEXCOORD4.zzz + u_xlat2.xyz;
    u_xlat2.xyz = hlslcc_mtx4x4unity_ObjectToWorld[3].xyz * vs_TEXCOORD4.www + u_xlat2.xyz;
    u_xlat2.xyz = (-u_xlat2.xyz) + _WorldSpaceCameraPos.xyz;
    u_xlat10 = dot(u_xlat2.xyz, u_xlat2.xyz);
    u_xlat10 = sqrt(u_xlat10);
    u_xlat10 = u_xlat10 + (-_FarMinDistance);
    u_xlat2.x = float(1.0) / _FarAddDistance;
    u_xlat10 = u_xlat10 * u_xlat2.x;
    u_xlat10 = clamp(u_xlat10, 0.0, 1.0);
    u_xlat2.x = u_xlat10 * -2.0 + 3.0;
    u_xlat10 = u_xlat10 * u_xlat10;
    u_xlat10 = u_xlat10 * u_xlat2.x;
    u_xlat2.xyz = vec3(u_xlat10) * u_xlat0.xyz + u_xlat1.xyz;
    u_xlat2.w = u_xlat10 * (-u_xlat9) + u_xlat9;
    SV_Target0 = u_xlat2;
    return;
}
