...
//
///////////////////////////////////////////
Shader "Spine/SkeletonCloakingEnemy" {
Properties {
...
_AlphaControl ("透明控制(_AlphaControl)", Range(0, 1)) = 1
_AlphaCheck ("特殊透明控制(_AlphaCheck)", Range(0, 1)) = 1
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat16_1 = u_xlat1.wwww * u_xlat1;
    u_xlat1 = u_xlat16_1 * vec4(vec4(_AlphaControl, _AlphaControl, _AlphaControl, _AlphaControl));
    u_xlat2 = u_xlat1 * vec4(vec4(_AlphaCheck, _AlphaCheck, _AlphaCheck, _AlphaCheck));
    u_xlat2 = u_xlat2 * _lineColor;
    u_xlat2 = u_xlat2 + u_xlat2;
    u_xlat1 = u_xlat1 * vec4(vec4(_AlphaCheck, _AlphaCheck, _AlphaCheck, _AlphaCheck)) + (-u_xlat2);
...
{
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    u_xlat0.x = _Time.x * _NoiseMoveSpeed;
    u_xlat0.y = vs_TEXCOORD0.y * _NoiseSize + u_xlat0.x;
    u_xlat0.x = vs_TEXCOORD0.x;
    u_xlat10_0 = texture2D(_NoiseTex, u_xlat0.xy).w;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat1 = u_xlat10_1 * vs_COLOR0;
    u_xlat16_0 = vec4(u_xlat10_0) * u_xlat1;
    u_xlat0 = u_xlat16_0 * vec4(vec4(_AlphaControl, _AlphaControl, _AlphaControl, _AlphaControl));
    u_xlat0 = u_xlat0 * vec4(vec4(_AlphaCheck, _AlphaCheck, _AlphaCheck, _AlphaCheck));
    u_xlat1.xy = hlslcc_FragCoord.xy * vec2(_TransSize);
    u_xlat10_1.xy = texture2D(_TransTex, u_xlat1.xy).xw;
    u_xlat1.x = u_xlat10_1.x * u_xlat10_1.y + (-_ShowEffect);
    ...
    u_xlat0 = u_xlat1.xxxx * (-u_xlat0) + u_xlat0;
    u_xlat0 = u_xlat0 * _lineColor;
    SV_Target0 = u_xlat0;
    return;
}
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    ...
    u_xlat0.x = u_xlat0.x * _AlphaControl;
    u_xlat0.x = u_xlat0.x * _AlphaCheck;
