...
//
///////////////////////////////////////////
Shader "Particles/Alpha Blend And Addivity" {
Properties {
...
void main()
{
    ...
    u_xlat0 = in_POSITION0 * vec4(_Scale);
...
void main()
{
    ...
    u_xlat3.xy = _Time.xx * vec2(_UVXMoveSpeed, _UVYMoveSpeed) + vs_TEXCOORD0.xy;
    u_xlat3.xy = fract(u_xlat3.xy);
    u_xlat10_1 = texture2D(_MainTex, u_xlat3.xy);
    u_xlat2 = vs_COLOR0 + vs_COLOR0;
    u_xlat2 = u_xlat2 * _TintColor;
    u_xlat1 = u_xlat10_1 * u_xlat2;
    u_xlat0.x = u_xlat0.x * u_xlat1.w;
    u_xlatb3 = _Use2DMask==1.0;
    SV_Target0.w = (u_xlatb3) ? u_xlat0.x : u_xlat1.w;
...
void main()
{
    ...
    vs_COLOR0 = in_COLOR0;
    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
    u_xlat2 = in_POSITION0 * vec4(_Scale);
    ...
    vs_TEXCOORD1 = hlslcc_mtx4x4unity_ObjectToWorld[3] * u_xlat2.wwww + u_xlat3;
...
void main()
{
    ...
    u_xlat1.w = dot(vs_COLOR0.ww, u_xlat3.xx);
...
void main()
{
    ...
    u_xlat2 = u_xlat2 * _TintColor;
    u_xlat1 = u_xlat10_1 * u_xlat2;
    u_xlat3.x = u_xlat1.w * _AddCheck;
    SV_Target0.xyz = u_xlat1.xyz;
    u_xlat0.x = u_xlat0.x * u_xlat3.x;
    u_xlatb6 = _Use2DMask==1.0;
    SV_Target0.w = (u_xlatb6) ? u_xlat0.x : u_xlat3.x;
    return;
}
