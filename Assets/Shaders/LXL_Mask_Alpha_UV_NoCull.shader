...
//
///////////////////////////////////////////
Shader "LXL/Mask_Alpha_UV_NoCull" {
Properties {
_Color ("Color", Color) = (0.7889273,0.8565936,0.9411765,1)
_diffuse ("diffuse", 2D) = "white" { }
_mask ("mask", 2D) = "black" { }
_u_speed ("u_speed", Range(-8, 8)) = 0
_v_speed ("v_speed", Range(-8, 8)) = -2
_diffuse_light ("diffuse_light", Range(0, 20)) = 11.11948
_mask_light ("mask_light", Range(0, 5)) = 5
...
void main()
{
    ...
    u_xlat1.xyz = u_xlat10_1.xyz * vec3(vec3(_mask_light, _mask_light, _mask_light));
    u_xlat6 = u_xlat10_0.w * u_xlat10_1.w;
