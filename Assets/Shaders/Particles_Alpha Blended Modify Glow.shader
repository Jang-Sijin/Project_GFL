...
//
///////////////////////////////////////////
Shader "Particles/Alpha Blended Modify Glow" {
Properties {
...
SubShader {
 Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderEffect" = "Glow11Transparent" "RenderType" = "Glow11Transparent" }
 Pass {
  Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RenderEffect" = "Glow11Transparent" "RenderType" = "Glow11Transparent" }
...
void main()
{
    u_xlat0.xy = _Time.xx * vec2(_UVXMoveSpeed, _UVYMoveSpeed) + vs_TEXCOORD0.xy;
