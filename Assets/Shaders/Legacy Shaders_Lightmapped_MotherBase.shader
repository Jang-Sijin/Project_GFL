...
//
///////////////////////////////////////////
Shader "Legacy Shaders/Lightmapped/MotherBase" {
Properties {
...
_NightMap ("Nightmap(RGB)", 2D) = "black" { }
_lerp ("dayToNight", Range(0, 1)) = 0
...
uniform lowp sampler2D _NightMap;
varying highp vec4 vs_TEXCOORD0;
varying highp vec3 vs_TEXCOORD1;
varying highp vec4 vs_TEXCOORD2;
...
void main()
{
    ...
    u_xlat5.x = float(1.0) / _AddDistance;
    ...
    u_xlat5.xy = vs_TEXCOORD2.xz * vec2(0.300000012, 0.300000012) + u_xlat5.xy;
    u_xlat5.x = sin(u_xlat5.x);
    u_xlat10 = cos(u_xlat5.y);
    u_xlat15 = _highFogAddDis + _highFogMinDis;
    u_xlat5.x = u_xlat5.x * u_xlat10 + u_xlat15;
    u_xlat5.x = u_xlat5.x + (-_highFogMinDis);
    u_xlat5.x = float(1.0) / u_xlat5.x;
    u_xlat10 = vs_TEXCOORD2.y + (-_highFogMinDis);
    u_xlat5.x = u_xlat5.x * u_xlat10;
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
    u_xlat10 = u_xlat5.x * -2.0 + 3.0;
    u_xlat5.x = u_xlat5.x * u_xlat5.x;
    u_xlat5.x = (-u_xlat10) * u_xlat5.x + 1.0;
    u_xlat10_1.xyz = texture2D(_NightMap, vs_TEXCOORD0.zw).xyz;
    u_xlat10_2.xyz = texture2D(_LightMap, vs_TEXCOORD0.zw).xyz;
    u_xlat2.xyz = u_xlat10_2.xyz * _Color.xyz;
    u_xlat1.xyz = u_xlat10_1.xyz * _NightColor.xyz + (-u_xlat2.xyz);
    u_xlat1.xyz = vec3(_lerp) * u_xlat1.xyz + u_xlat2.xyz;
    u_xlat10_2.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = u_xlat1.xyz * u_xlat10_2.xyz;
    u_xlat1.xyz = (-u_xlat1.xyz) * u_xlat10_2.xyz + _HighFogColor.xyz;
    u_xlat16_4.xyz = u_xlat10_2.xyz * _LightColor0.xyz;
    u_xlat5.xyz = u_xlat5.xxx * u_xlat1.xyz + u_xlat16_3.xyz;
    u_xlat1.xyz = (-u_xlat5.xyz) + _FarFogColor.xyz;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat1.xyz + u_xlat5.xyz;
    u_xlat16_3.x = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_3.x = max(u_xlat16_3.x, 0.0);
    SV_Target0.xyz = u_xlat16_4.xyz * u_xlat16_3.xxx + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_3.x = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_3.x = max(u_xlat16_3.x, 0.0);
    u_xlat16_8.xyz = u_xlat10_2.xyz * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat0.xy = vs_TEXCOORD2.xz * vec2(0.300000012, 0.300000012) + u_xlat0.xy;
    ...
    u_xlat5.x = vs_TEXCOORD2.y + (-_highFogMinDis);
    u_xlat0.x = u_xlat0.x * u_xlat5.x;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat5.x = u_xlat0.x * -2.0 + 3.0;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = (-u_xlat5.x) * u_xlat0.x + 1.0;
    u_xlat10_5.xyz = texture2D(_NightMap, vs_TEXCOORD0.zw).xyz;
    u_xlat10_1.xyz = texture2D(_LightMap, vs_TEXCOORD0.zw).xyz;
    u_xlat1.xyz = u_xlat10_1.xyz * _Color.xyz;
    u_xlat5.xyz = u_xlat10_5.xyz * _NightColor.xyz + (-u_xlat1.xyz);
    u_xlat5.xyz = vec3(_lerp) * u_xlat5.xyz + u_xlat1.xyz;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat5.xyz * u_xlat10_1.xyz;
    u_xlat5.xyz = (-u_xlat5.xyz) * u_xlat10_1.xyz + _HighFogColor.xyz;
    ...
    u_xlat16 = float(1.0) / _AddDistance;
    ...
    u_xlat15 = clamp(u_xlat15, 0.0, 1.0);
    u_xlat16 = texture2D(_ShadowMapTexture, vs_TEXCOORD5.xy).x;
    u_xlatb16 = vs_TEXCOORD5.z<u_xlat16;
    u_xlat16 = u_xlatb16 ? 1.0 : float(0.0);
    u_xlat16 = max(u_xlat16, _LightShadowData.x);
    u_xlat16_2.x = (-u_xlat16) + 1.0;
    u_xlat16_2.x = u_xlat15 * u_xlat16_2.x + u_xlat16;
    u_xlat16_2.xyz = u_xlat16_2.xxx * _LightColor0.xyz;
    u_xlat16_2.xyz = u_xlat10_1.xyz * u_xlat16_2.xyz;
    u_xlat16_17 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_17 = max(u_xlat16_17, 0.0);
    SV_Target0.xyz = u_xlat16_2.xyz * vec3(u_xlat16_17) + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat5.x = u_xlat0.y + (-_MinDistance);
    ...
    u_xlat16_2.x = u_xlat0.x * u_xlat16_2.x + u_xlat10;
    u_xlat16_2.xyz = u_xlat16_2.xxx * _LightColor0.xyz;
    u_xlat10_0.xzw = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * u_xlat10_0.xzw;
    ...
    u_xlat16_3.xyz = u_xlat10_0.xzw * u_xlat1.xyz;
    u_xlat16_17 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_17 = max(u_xlat16_17, 0.0);
    ...
    u_xlat1.xy = vs_TEXCOORD2.xz * vec2(0.300000012, 0.300000012) + u_xlat1.xy;
    u_xlat1.x = sin(u_xlat1.x);
    u_xlat6.x = cos(u_xlat1.y);
    u_xlat11 = _highFogAddDis + _highFogMinDis;
    u_xlat1.x = u_xlat1.x * u_xlat6.x + u_xlat11;
    u_xlat1.x = u_xlat1.x + (-_highFogMinDis);
    u_xlat1.x = float(1.0) / u_xlat1.x;
    u_xlat6.x = vs_TEXCOORD2.y + (-_highFogMinDis);
    u_xlat1.x = u_xlat1.x * u_xlat6.x;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat6.x = u_xlat1.x * -2.0 + 3.0;
    u_xlat1.x = u_xlat1.x * u_xlat1.x;
    u_xlat1.x = (-u_xlat6.x) * u_xlat1.x + 1.0;
    u_xlat10_6.xyz = texture2D(_NightMap, vs_TEXCOORD0.zw).xyz;
    u_xlat10_4.xyz = texture2D(_LightMap, vs_TEXCOORD0.zw).xyz;
    u_xlat4.xyz = u_xlat10_4.xyz * _Color.xyz;
    u_xlat6.xyz = u_xlat10_6.xyz * _NightColor.xyz + (-u_xlat4.xyz);
    u_xlat6.xyz = vec3(_lerp) * u_xlat6.xyz + u_xlat4.xyz;
    u_xlat16_3.xyz = u_xlat10_0.xzw * u_xlat6.xyz;
    u_xlat0.xzw = (-u_xlat6.xyz) * u_xlat10_0.xzw + _HighFogColor.xyz;
    u_xlat0.xzw = u_xlat1.xxx * u_xlat0.xzw + u_xlat16_3.xyz;
    u_xlat1.xyz = (-u_xlat0.xzw) + _FarFogColor.xyz;
...
void main()
{
    ...
    u_xlat0.x = sqrt(u_xlat0.x);
    u_xlat0.x = u_xlat0.x + (-_MinDistance);
    u_xlat4.x = float(1.0) / _AddDistance;
    u_xlat0.x = u_xlat4.x * u_xlat0.x;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat4.x = u_xlat0.x * -2.0 + 3.0;
    u_xlat0.x = u_xlat0.x * u_xlat0.x;
    u_xlat0.x = u_xlat0.x * u_xlat4.x;
    u_xlat4.xy = _Time.xx * vec2(20.0, 30.0);
    u_xlat4.xy = vs_TEXCOORD1.xz * vec2(0.300000012, 0.300000012) + u_xlat4.xy;
    u_xlat4.x = sin(u_xlat4.x);
    u_xlat8 = cos(u_xlat4.y);
    u_xlat12 = _highFogAddDis + _highFogMinDis;
    u_xlat4.x = u_xlat4.x * u_xlat8 + u_xlat12;
    u_xlat4.x = u_xlat4.x + (-_highFogMinDis);
    u_xlat4.x = float(1.0) / u_xlat4.x;
    u_xlat8 = vs_TEXCOORD1.y + (-_highFogMinDis);
    ...
    u_xlat1.xyz = (-u_xlat4.xyz) + _FarFogColor.xyz;
