...
//
///////////////////////////////////////////
Shader "Va11/Dissolve" {
Properties {
_MainTex ("Texture", 2D) = "white" { }
_Color ("Tint", Color) = (1,1,1,1)
_NoiseTex ("噪声图", 2D) = "white" { }
_Dissolve ("方向与时间系数", Range(-0.99, 0.99)) = 0.99
_SetTime ("时间", Float) = 1
_EdgeWidth ("边缘宽度", Range(0, 1)) = 1
...
uniform 	mediump float _SetTime;
...
void main()
{
    u_xlat10_0.x = texture2D(_NoiseTex, vs_TEXCOORD0.xy).x;
    u_xlat16_1 = _Dissolve * _SetTime;
    u_xlat16_1 = fract(u_xlat16_1);
    u_xlat16_4 = u_xlat10_0.x + (-u_xlat16_1);
    u_xlat16_1 = u_xlat16_1 * _EdgeWidth;
    u_xlat16_1 = u_xlat16_4 / u_xlat16_1;
    u_xlat16_1 = clamp(u_xlat16_1, 0.0, 1.0);
    u_xlat16_1 = (-u_xlat16_1) + 1.0;
    u_xlat10_0 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat0 = u_xlat10_0 * vs_COLOR0;
    u_xlat16_2 = u_xlat0 * _EdgeColor + (-u_xlat0);
    SV_Target0 = vec4(u_xlat16_1) * u_xlat16_2 + u_xlat0;
    return;
}
