...
//
///////////////////////////////////////////
Shader "Unlit/UGUITexComplex(Clip)" {
Properties {
...
_worldClipBottom ("World Height", Float) = 1.48
}
SubShader {
...
uniform 	float _worldClipBottom;
...
void main()
{
    ...
    u_xlatb4 = 0.0<_UseClip;
    u_xlat0.x = (u_xlatb4) ? u_xlat0.x : u_xlat16_1;
    u_xlatb4 = vs_TEXCOORD1.y<_worldClipBottom;
    u_xlatb8 = _verticalFill<vs_TEXCOORD0.y;
