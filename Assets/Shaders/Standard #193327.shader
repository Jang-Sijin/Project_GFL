...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat6.xyz * vec3(u_xlat16_20) + u_xlat16_4.xyz;
...
void main()
{
    ...
    u_xlat16_23 = u_xlat10_0 * _OcclusionStrength + u_xlat16_23;
    ...
    u_xlat4.x = texture2D(unity_NHxRoughness, u_xlat0.yz).x;
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat10_6.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = _Color.xyz * u_xlat10_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat6.xyz = u_xlat10_6.xyz * _Color.xyz;
    u_xlat16_4.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_4.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat8.x = texture2D(_ShadowMapTexture, vs_TEXCOORD7.xy).x;
    u_xlatb8 = vs_TEXCOORD7.z<u_xlat8.x;
    u_xlat8.x = u_xlatb8 ? 1.0 : float(0.0);
    u_xlat8.x = max(u_xlat8.x, _LightShadowData.x);
    u_xlat16_2.x = (-u_xlat8.x) + 1.0;
    u_xlat16_2.x = u_xlat0.x * u_xlat16_2.x + u_xlat8.x;
    ...
    u_xlat0.xyz = u_xlat8.xyz * vec3(u_xlat16_28) + u_xlat5.xyz;
...
void main()
{
    ...
    u_xlat10_2 = textureCubeLodEXT(unity_SpecCube0, vs_TEXCOORD4.yzw, u_xlat16_22);
...
void main()
{
    ...
    u_xlat0.x = u_xlat0.x * _LightShadowData.z + _LightShadowData.w;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat9.x = texture2D(_ShadowMapTexture, vs_TEXCOORD7.xy).x;
    u_xlatb9 = vs_TEXCOORD7.z<u_xlat9.x;
    ...
    u_xlat4.xyz = u_xlat10_9.xyz * _Color.xyz;
    ...
    u_xlat16_8.xyz = u_xlat16_2.xxx * u_xlat4.xyz;
...
void main()
{
    ...
    u_xlat1.x = texture2D(unity_NHxRoughness, u_xlat0.xy).x;
    ...
    u_xlat16_2.xyz = u_xlat4.xyz * vec3(u_xlat16_11) + u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat0.x = u_xlat16_0;
    u_xlat0.y = (-_Glossiness) + 1.0;
    u_xlat1 = texture2D(unity_NHxRoughness, u_xlat0.xy).x;
...
void main()
{
    ...
    u_xlat1.x = u_xlat1.x * 16.0;
    u_xlat10_5.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_2.xyz = _Color.xyz * u_xlat10_5.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat5.xyz = u_xlat10_5.xyz * _Color.xyz;
    u_xlat16_2.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_2.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_2.xyz = u_xlat1.xxx * u_xlat16_2.xyz;
    u_xlat16_14 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_2.xyz = u_xlat5.xyz * vec3(u_xlat16_14) + u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat1 = texture2D(_LightTextureB0, vec2(u_xlat1)).x;
    u_xlat4.x = textureCube(_LightTexture0, vs_TEXCOORD5.xyz).w;
    u_xlat1 = u_xlat4.x * u_xlat1;
    u_xlat16_11 = dot(vs_TEXCOORD4.xyz, vs_TEXCOORD3.xyz);
    u_xlat16_11 = clamp(u_xlat16_11, 0.0, 1.0);
    u_xlat16_11 = u_xlat1 * u_xlat16_11;
    SV_Target0.xyz = vec3(u_xlat16_11) * u_xlat16_2.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat1.x = dot(vs_TEXCOORD6.xyz, vs_TEXCOORD6.xyz);
    u_xlat1.x = texture2D(_LightTextureB0, u_xlat1.xx).x;
    u_xlat5 = textureCube(_LightTexture0, vs_TEXCOORD6.xyz).w;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat4.xyz * vec3(u_xlat16_11) + u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _LightColor0.xyz;
    u_xlat1 = texture2D(_LightTexture0, vs_TEXCOORD5.xy).w;
    u_xlat16_11 = dot(vs_TEXCOORD4.xyz, vs_TEXCOORD3.xyz);
    u_xlat16_11 = clamp(u_xlat16_11, 0.0, 1.0);
    u_xlat16_11 = u_xlat1 * u_xlat16_11;
    SV_Target0.xyz = vec3(u_xlat16_11) * u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat16_3.x = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat0.xzw = u_xlat1.xyz * u_xlat16_3.xxx + u_xlat0.xzw;
    u_xlat1.x = texture2D(_LightTexture0, vs_TEXCOORD6.xy).w;
    u_xlat16_3.xyz = u_xlat1.xxx * _LightColor0.xyz;
    u_xlat0.xzw = u_xlat0.xzw * u_xlat16_3.xyz;
    u_xlat0.xyz = vec3(u_xlat4) * u_xlat0.xzw;
    SV_Target0.xyz = u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat16_1 = u_xlat16_5.x * u_xlat16_1;
    u_xlat16_5.x = dot(vs_TEXCOORD2.yzw, vs_TEXCOORD3.xyz);
...
void main()
{
    ...
    u_xlat16_3 = u_xlat16_9.x * u_xlat16_3;
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat10_6.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_9.xyz = _Color.xyz * u_xlat10_6.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat6.xyz = u_xlat10_6.xyz * _Color.xyz;
    ...
    u_xlat16_9.xyz = u_xlat6.xyz * vec3(u_xlat16_5) + u_xlat16_9.xyz;
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat4.xyz * vec3(u_xlat16_11) + u_xlat16_2.xyz;
    u_xlat16_2.xyz = u_xlat16_2.xyz * _LightColor0.xyz;
    u_xlat1 = texture2D(_ShadowMapTexture, vs_TEXCOORD6.xy).x;
    u_xlatb1 = vs_TEXCOORD6.z<u_xlat1;
    u_xlat1 = u_xlatb1 ? 1.0 : float(0.0);
    u_xlat1 = max(u_xlat1, _LightShadowData.x);
    u_xlat16_11 = dot(vs_TEXCOORD4.xyz, vs_TEXCOORD3.xyz);
    u_xlat16_11 = clamp(u_xlat16_11, 0.0, 1.0);
    u_xlat16_11 = u_xlat1 * u_xlat16_11;
    SV_Target0.xyz = vec3(u_xlat16_11) * u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat1 = u_xlatb1 ? 1.0 : float(0.0);
    u_xlat1 = max(u_xlat1, _LightShadowData.x);
    u_xlat4.x = texture2D(_LightTexture0, vs_TEXCOORD5.xy).w;
...
void main()
{
    ...
    u_xlat16_2.x = (-u_xlat5.x) + 1.0;
    u_xlat16_2.x = u_xlat0.x * u_xlat16_2.x + u_xlat5.x;
    u_xlat0.x = texture2D(_LightTexture0, vs_TEXCOORD6.xy).w;
...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat5.xyz * vec3(u_xlat16_4) + u_xlat16_7.xyz;
...
void main()
{
    ...
    u_xlat16_11.x = dot(vs_TEXCOORD2.yzw, vs_TEXCOORD3.xyz);
    u_xlat16_11.x = u_xlat16_11.x * u_xlat16_11.x;
    u_xlat16_5 = u_xlat16_11.x * u_xlat16_11.x;
    u_xlat5.x = u_xlat16_5;
    u_xlat5.y = (-_Glossiness) + 1.0;
    ...
    u_xlat16_11.xyz = u_xlat7.xyz * vec3(u_xlat16_6) + u_xlat16_11.xyz;
    u_xlat16_11.xyz = u_xlat16_11.xyz * _LightColor0.xyz;
    SV_Target0.xyz = vec3(u_xlat16_4) * u_xlat16_11.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_22 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat0.xzw = u_xlat1.xyz * vec3(u_xlat16_22) + u_xlat0.xzw;
...
void main()
{
    ...
    u_xlat0.x = dot(vs_TEXCOORD5.xyz, vs_TEXCOORD5.xyz);
    u_xlat0.x = texture2D(_LightTextureB0, u_xlat0.xx).x;
    u_xlat5.x = textureCube(_LightTexture0, vs_TEXCOORD5.xyz).w;
    u_xlat0.x = u_xlat5.x * u_xlat0.x;
    u_xlat0.x = u_xlat16_2 * u_xlat0.x;
    u_xlat16_2 = dot(vs_TEXCOORD4.xyz, vs_TEXCOORD3.xyz);
    u_xlat16_2 = clamp(u_xlat16_2, 0.0, 1.0);
...
void main()
{
    ...
    u_xlat0.x = dot(vs_TEXCOORD6.xyz, vs_TEXCOORD6.xyz);
    u_xlat0.x = texture2D(_LightTextureB0, u_xlat0.xx).x;
    u_xlat6.x = textureCube(_LightTexture0, vs_TEXCOORD6.xyz).w;
    u_xlat0.x = u_xlat6.x * u_xlat0.x;
    u_xlat0.x = u_xlat16_4.x * u_xlat0.x;
    u_xlat16_4.xyz = u_xlat0.xxx * _LightColor0.xyz;
    u_xlat0.x = dot(vs_TEXCOORD1.xyz, vs_TEXCOORD1.xyz);
...
void main()
{
    ...
    u_xlat16_2.xyz = u_xlat10_1.xyz * u_xlat16_2.xxx;
    u_xlat10_0 = texture2D(_OcclusionMap, vs_TEXCOORD0.xy).y;
    u_xlat16_2.xyz = vec3(u_xlat10_0) * u_xlat16_2.xyz;
    u_xlat16_20 = dot(vs_TEXCOORD4.yzw, _WorldSpaceLightPos0.xyz);
    u_xlat16_20 = u_xlat16_20 * u_xlat16_20;
    u_xlat16_6 = u_xlat16_20 * u_xlat16_20;
    u_xlat0.y = u_xlat16_6;
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_OcclusionMap, vs_TEXCOORD0.xy).y;
    u_xlat16_2.xyz = vec3(u_xlat10_0) * u_xlat16_2.xyz;
    u_xlat16_3.xyz = vec3(u_xlat10_0) * vs_TEXCOORD2.xyz;
    u_xlat10_4.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_5.xyz = _Color.xyz * u_xlat10_4.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat4.xyz = u_xlat10_4.xyz * _Color.xyz;
    u_xlat16_5.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_5.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
...
void main()
{
    ...
    u_xlat1.y = (-_Glossiness) + 1.0;
    u_xlat5 = texture2D(unity_NHxRoughness, u_xlat1.xy).x;
    u_xlat5 = u_xlat5 * 16.0;
    u_xlat10_1.xyz = texture2D(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_3.xyz = _Color.xyz * u_xlat10_1.xyz + vec3(-0.220916301, -0.220916301, -0.220916301);
    u_xlat1.xyz = u_xlat10_1.xyz * _Color.xyz;
    u_xlat16_3.xyz = vec3(vec3(_Metallic, _Metallic, _Metallic)) * u_xlat16_3.xyz + vec3(0.220916301, 0.220916301, 0.220916301);
    u_xlat16_3.xyz = vec3(u_xlat5) * u_xlat16_3.xyz;
    u_xlat16_18 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_3.xyz = u_xlat1.xyz * vec3(u_xlat16_18) + u_xlat16_3.xyz;
    u_xlat5 = dot(vs_TEXCOORD6.xyz, vs_TEXCOORD6.xyz);
    u_xlat5 = texture2D(_LightTextureB0, vec2(u_xlat5)).x;
    u_xlat10 = textureCube(_LightTexture0, vs_TEXCOORD6.xyz).w;
...
void main()
{
    ...
    u_xlat16_18 = (-_Metallic) * 0.779083729 + 0.779083729;
    u_xlat16_3.xyz = u_xlat1.xyz * vec3(u_xlat16_18) + u_xlat16_3.xyz;
    u_xlat5 = texture2D(_LightTexture0, vs_TEXCOORD6.xy).w;
    u_xlat16_4.xyz = vec3(u_xlat5) * _LightColor0.xyz;
    u_xlat16_4.xyz = u_xlat0.xxx * u_xlat16_4.xyz;
    SV_Target0.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
    SV_Target0.w = 1.0;
...
void main()
{
    ...
    u_xlat5.x = texture2D(_ShadowMapTexture, u_xlat5.xy).x;
    u_xlatb5 = u_xlat5.x<u_xlat5.z;
    u_xlat16_4.x = (u_xlatb5) ? _LightShadowData.x : 1.0;
