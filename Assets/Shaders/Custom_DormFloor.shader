...
void main()
{
    ...
    u_xlat0.zw = in_TEXCOORD1.xy * _ShadowTex_ST.xy + _ShadowTex_ST.zw;
...
void main()
{
    u_xlat10_0 = texture2D(_ShadowTex, vs_TEXCOORD1.xy).w;
    u_xlat0.x = u_xlat10_0 * vs_COLOR0.w;
    u_xlat0.x = (-u_xlat0.x) * 0.600000024 + 1.0;
