...
void main()
{
    ...
    vs_TEXCOORD2.xy = u_xlat0.xx + vec2(0.5, 0.5);
...
void main()
{
    ...
    u_xlat16_1 = (-u_xlat0.x) * u_xlat10_2 + 1.0;
    u_xlatb0 = 0.980000019>=u_xlat16_1;
    u_xlat16_1 = (u_xlatb0) ? 1.0 : 0.0;
    u_xlat10_0 = texture2D(_DecoTex, vs_TEXCOORD2.xy);
...
void main()
{
    ...
    u_xlat2 = u_xlat10_2 * vs_COLOR0.w;
    u_xlat10_4 = texture2D(_AlphaTex, vs_TEXCOORD0.xy).x;
    u_xlat2 = u_xlat10_4 * u_xlat2;
    u_xlat16_1 = (-u_xlat2) * u_xlat0.x + 1.0;
    u_xlatb0.x = 0.980000019>=u_xlat16_1;
