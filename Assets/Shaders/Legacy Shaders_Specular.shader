...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_3.xyz * vec3(u_xlat16_14) + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * vs_TEXCOORD3.xyz + u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat6 = texture2D(_ShadowMapTexture, vs_TEXCOORD5.xy).x;
    u_xlatb6 = vs_TEXCOORD5.z<u_xlat6;
    u_xlat6 = u_xlatb6 ? 1.0 : float(0.0);
    u_xlat6 = max(u_xlat6, _LightShadowData.x);
    u_xlat16_20 = (-u_xlat6) + 1.0;
    u_xlat16_20 = u_xlat0.x * u_xlat16_20 + u_xlat6;
    ...
    u_xlat0.xyz = u_xlat16_2.xyz * vec3(u_xlat16_20) + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_20 = dot(vs_TEXCOORD1.xyz, _WorldSpaceLightPos0.xyz);
    u_xlat16_20 = max(u_xlat16_20, 0.0);
    u_xlat0.xyz = u_xlat16_4.xyz * vec3(u_xlat16_20) + u_xlat0.xyz;
