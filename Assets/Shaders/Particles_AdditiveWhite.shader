...
//
///////////////////////////////////////////
Shader "Particles/AdditiveWhite" {
Properties {
_MainTex ("Sprite Texture", 2D) = "white" { }
_TintColor ("Tint", Color) = (1,1,1,1)
_Guodu ("过渡", Range(0, 1)) = 0
...
void main()
{
    ...
    u_xlat2.xyz = (-u_xlat0.xyz) * u_xlat10_1.xyz + _TintColor.xyz;
    u_xlat0 = u_xlat0 * u_xlat10_1;
    u_xlat1.xyz = vec3(_Guodu) * u_xlat2.xyz + u_xlat0.xyz;
    u_xlat1.w = u_xlat0.w * _Guodu;
    SV_Target0 = u_xlat1;
    return;
}
