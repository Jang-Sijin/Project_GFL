...
void main()
{
    ...
    u_xlat16_4.xyz = u_xlat10_1.xyz * u_xlat2.xyz;
    u_xlat16_3.xyz = u_xlat2.xyz * _LightColor0.xyz;
...
void main()
{
    ...
    u_xlat10_3.xyz = texture2D(_LightMap, vs_TEXCOORD0.zw).xyz;
    SV_Target0.xyz = u_xlat10_3.xyz * u_xlat1.xyz + u_xlat16_0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_1.xyz = u_xlat10_2.xyz * u_xlat3.xyz;
    SV_Target0.xyz = u_xlat3.xyz * u_xlat0.xyz + u_xlat16_1.xyz;
    SV_Target0.w = 1.0;
    return;
}
