...
SubShader {
 Tags { "CanUseSpriteAtlas" = "true" "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Transparent" "RenderEffect" = "Transparent" "RenderType" = "Transparent" }
 Pass {
  Name "Default"
  Tags { "CanUseSpriteAtlas" = "true" "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Transparent" "RenderEffect" = "Transparent" "RenderType" = "Transparent" }
...
void main()
{
    ...
    u_xlat10_0 = texture2D(_GradientMap, u_xlat0.xy);
...
void main()
{
    ...
    u_xlat1.x = cos(u_xlat0.x);
    u_xlat0.x = sin(u_xlat0.x);
    u_xlat4.xy = vs_TEXCOORD0.yx + vec2(-0.5, -0.5);
    u_xlat0.xw = u_xlat0.xx * u_xlat4.xy;
    u_xlat2.x = u_xlat4.y * u_xlat1.x + (-u_xlat0.x);
    u_xlat2.y = u_xlat4.x * u_xlat1.x + u_xlat0.w;
    u_xlat0.xy = u_xlat2.xy + vec2(0.5, 0.5);
    u_xlat10_0 = texture2D(_GradientMap, u_xlat0.xy);
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat1 = u_xlat10_1 + _TextureSampleAdd;
    u_xlat1 = u_xlat1 * vs_COLOR0;
    u_xlat16_3 = u_xlat1.w * u_xlat10_0.w + -0.00100000005;
    u_xlat0 = u_xlat10_0 * u_xlat1;
    SV_Target0 = u_xlat0;
...
void main()
{
    ...
    u_xlat4.x = _Angle * 0.0174532942;
    u_xlat1.x = sin(u_xlat4.x);
    u_xlat2.x = cos(u_xlat4.x);
    u_xlat4.xy = vs_TEXCOORD0.yx + vec2(-0.5, -0.5);
    u_xlat1.xy = u_xlat1.xx * u_xlat4.xy;
    u_xlat3.x = u_xlat4.y * u_xlat2.x + (-u_xlat1.x);
    u_xlat3.y = u_xlat4.x * u_xlat2.x + u_xlat1.y;
    u_xlat4.xy = u_xlat3.xy + vec2(0.5, 0.5);
    u_xlat10_1 = texture2D(_GradientMap, u_xlat4.xy);
