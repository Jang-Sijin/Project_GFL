...
//
///////////////////////////////////////////
Shader "Unlit/GlowReplacementShader" {
Properties {
_MainTex ("Texture", 2D) = "white" { }
_AlphaR ("Alpha Texture", 2D) = "white" { }
}
SubShader {
 Tags { "MobileGlow" = "Geometry" }
 Pass {
  Tags { "MobileGlow" = "Geometry" }
  GpuProgramID 23639
Program "vp" {
...
void main()
{
    ...
    SV_Target0.xyz = vec3(u_xlat10_0) * u_xlat10_2.xyz;
    SV_Target0.w = 1.0;
    return;
}
