...
void main()
{
    u_xlat16_0.x = vs_TEXCOORD2.z + 2.0;
    u_xlat16_0.xy = vs_TEXCOORD2.xy / u_xlat16_0.xx;
    ...
    u_xlat16_0 = u_xlat16_0.xxxx * _Direction.xyxy;
    u_xlat0 = u_xlat16_0 * vec4(_MoveSpeed);
    u_xlat1.xy = u_xlat0.xy * _Time.xx + u_xlat1.xy;
    u_xlat0 = u_xlat0 * _Time.xxxx;
    u_xlat10_2 = texture2D(_CloudTex, u_xlat1.xy);
    ...
    u_xlat11.xy = u_xlat0.zw * vec2(8.0, 8.0) + u_xlat11.xy;
    u_xlat1.xy = u_xlat0.xy * vec2(4.0, 4.0) + u_xlat1.xy;
    u_xlat10_0 = texture2D(_CloudTex, u_xlat1.xy);
    u_xlat0 = u_xlat10_0 * vec4(0.800000012, 0.800000012, 0.800000012, 0.800000012);
    u_xlat16_0 = max(u_xlat0, u_xlat10_2);
    u_xlat10_1 = texture2D(_CloudTex, u_xlat11.xy);
    u_xlat1 = u_xlat10_1 * vec4(0.5, 0.5, 0.5, 0.5);
    u_xlat16_0 = max(u_xlat16_0, u_xlat1);
    u_xlat16_1 = (-vec4(vec4(_CloudPower, _CloudPower, _CloudPower, _CloudPower))) * u_xlat16_0 + _CloudColor;
    ...
    u_xlat16_2 = (-u_xlat16_1) * vec4(vec4(_Power, _Power, _Power, _Power)) + u_xlat16_0;
    u_xlat1 = u_xlat16_1 * vec4(vec4(_Power, _Power, _Power, _Power));
    u_xlat16_4 = u_xlat16_0.x * u_xlat1.w;
    u_xlat16_2 = vec4(u_xlat16_4) * u_xlat16_2 + u_xlat1;
    u_xlat0 = u_xlat1 * u_xlat16_0 + (-u_xlat16_2);
    u_xlat0 = vec4(vec4(_Guodu, _Guodu, _Guodu, _Guodu)) * u_xlat0 + u_xlat16_2;
    u_xlat0 = u_xlat0 * _RenderColor;
    u_xlat0 = u_xlat0 * vec4(_Compare);
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat10_1 = texture2D(_CloudTex, u_xlat1.xy);
    u_xlat3.xy = vs_TEXCOORD0.xy * vec2(2.0, 2.0) + u_xlat16_0.xy;
    u_xlat13.xy = vs_TEXCOORD0.xy * vec2(4.0, 4.0) + u_xlat16_0.zw;
    u_xlat13.xy = u_xlat2.zw * vec2(8.0, 8.0) + u_xlat13.xy;
    u_xlat3.xy = u_xlat2.xy * vec2(4.0, 4.0) + u_xlat3.xy;
    u_xlat10_0 = texture2D(_CloudTex, u_xlat3.xy);
    u_xlat0 = u_xlat10_0 * vec4(0.800000012, 0.800000012, 0.800000012, 0.800000012);
    u_xlat16_0 = max(u_xlat0, u_xlat10_1);
    u_xlat10_1 = texture2D(_CloudTex, u_xlat13.xy);
    u_xlat1 = u_xlat10_1 * vec4(0.5, 0.5, 0.5, 0.5);
    u_xlat16_0 = max(u_xlat16_0, u_xlat1);
    u_xlat1 = u_xlat16_0 * vec4(_CloudPower);
    u_xlat16_4 = _CloudPower * u_xlat16_0.x + -0.300000012;
    u_xlat16_4 = clamp(u_xlat16_4, 0.0, 1.0);
    u_xlat16_0 = (-vec4(_CloudPower)) * u_xlat16_0 + _CloudColor;
    u_xlat16_0 = vec4(u_xlat16_4) * u_xlat16_0 + u_xlat1;
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_1 = u_xlat10_1 * vs_COLOR0;
    u_xlat16_2 = (-u_xlat16_1) * vec4(vec4(_Power, _Power, _Power, _Power)) + u_xlat16_0;
    u_xlat1 = u_xlat16_1 * vec4(vec4(_Power, _Power, _Power, _Power));
